...
StandbyActive = True
ledActive = True
ledTechnology = pcf8574usage        #None or 'GPIOusage' or 'pcf8574usage'
...
oledtext01 = 36, 2        #Artist
oledtext02 = 36, 22       #Title
oledtext03 = 65, 4       #clock
oledtext04 = 30, 41      #IP
oledtext05 = 172, 41     #Date
oledtext06 = 36, 41       #format
oledtext07 = 148, 41     #samplerate
oledtext08 = 209, 41     #bitdepth
...
oledtext15 = 50, 15      #Text for Albums
oledtext16 = 50, 28      #Text for Songs
oledtext17 = 50, 41      #Text for duration
oledtext18 = 134, 52     #Menu-Label Icon
oledtext19 = 226, 54     #LibraryInfoIcon
oledtext20 = 36, 2        #icon for Artists
oledtext21 = 36, 15       #icon for Albums
oledtext22 = 36, 28      #icon for Songs
oledtext23 = 36, 41       #icon for duration

#configuration TextPositions Spectrum-Screen:
oledtext24 = 36, 2        #Artist Non-Stream-Screen
oledtext25 = 36, 22       #Title Non-Stream-Screen
oledtext26 = 36, 2        #Artist Stream-Screen
oledtext27 = 36, 22       #Title Stream-Screen

#configuration Menu-Screen:
oledListEntrys = 4
oledEmptyListText = 'no items..'
oledEmptyListTextPosition = 40, 30
oledListTextPosX = 36
oledListTextPosY = 16    #height of each Entry (4x16 = 64)

#configuration of the duration and playtime (textbox-) positions
oledActualPlaytimeText = 36, 54
oledDurationText = 210, 54
...
class NowPlayingScreen():
    def __init__(self, height, width): #this line references to oled.modal = NowPlayingScreen
        ...
        self.text3Pos = oledtext03        #clock (clock  text is 161 pixels long) (222px viewable - text = 73 : 2 = 31 + 42offset = 73)
...
# "def DrawON(..." takes informations from above and creates a "picture" which then is transfered to your display	
    ...
    def SetPlayingIcon(self, time=0):
        ...
        self.alfaimage.paste((0, 0, 0, oledBackgroundVisibility), [0, 0, image.size[0], image.size[1]])                 #(0, 0, 0, 200) means Background (nowplayingscreen with artist, song etc.) is darkend. Change 200 to 0 -> Background is completely visible. 255 -> Bachground is not visible. scale = 0-255
        drawalfa = ImageDraw.Draw(self.alfaimage)
        iconwidth, iconheight = drawalfa.textsize(self.playingIcon, font=iconfont)            #entypo
        left = (self.width - iconwidth + 34) / 2						   #here is defined where the play/pause/stop icons are displayed. 
        drawalfa.text((left, 4), self.playingIcon, font=iconfont, fill=(255, 255, 255, oledPlaystateIconVisibility))  #(255, 255, 255, 200) means Icon is nearly white. Change 200 to 0 -> icon is not visible. scale = 0-255
