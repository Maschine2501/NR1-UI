...
oledtext07 = 159, 41     #samplerate
oledtext08 = 220, 41     #bitdepth
...
def onPushCollectionStats(data):
    ...
    if oled.state == STATE_LIBRARY_INFO and oled.playState == 'info':                                   #this is the "Media-Library-Info-Screen"
       oled.modal.UpdateLibraryInfo() #oled.activeArtists, oled.activeAlbums, oled.activeSongs, oled.activePlaytime, oledArt, oledAlb, oledSon, oledPla, oledlibraryInfo, oledlibraryReturn, oledArtistIcon, oledAlbumIcon, oledSongIcon, oledPlaytimeIcon)  #
...
class MediaLibrarayInfo():
    def __init__(self, height, width): #, row1, row2, row3, row4, row5, row6, row7, row8, row9, row10, row11, row12, row13, row14, fontaw, font5, iconfontBottom, labelfont, lablefont2, mediaicon): 
        ...
        self.LibraryInfoText9 = StaticText(self.height, self.width, oledlibraryInfo, labelfont2)  	    #Menu-label Icon
