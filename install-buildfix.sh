...
# Thanks @2aCD for the following lines:
...
# 2aCD has postet this fix here: https://community.volumio.org/t/cannot-install-build-essential-package/46856/16?u=maschine2501
sudo apt-get update #
